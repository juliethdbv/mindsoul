...
@AllArgsConstructor
public class RecordPacExporterPdf{
    ...
    celda.setPhrase(new Phrase("Psicologo",fuente));
    tabla.addCell(celda);
    ...
    private void escribirDatosDeLaTabla(PdfPTable tabla){
        for(Record record : listRecord){
            ...
            tabla.addCell(String.valueOf(record.getAppointments().getDoctor()));
        }
    }
    ...
    public void exportar(HttpServletResponse res) throws DocumentException, IOException{
        ...
        Paragraph titulo = new Paragraph("Lista de Historial mis Citas",fuente);
